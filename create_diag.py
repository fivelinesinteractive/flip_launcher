...
labels = Font(family='Helvetica', size=20, weight='bold')
inputs = Font(family='Helvetica', size=20, weight='normal')
...
entext = StringVar()
en = Entry(root, textvariable=entext, width=15, font=inputs)
en.focus()
